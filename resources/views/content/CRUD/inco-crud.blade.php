...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Tables /</span> Inconnu
</h4>
...
<div class="card">
  <h5 class="card-header">Liste des Inconnus enregistrés</h5>
    ...
    <table class="table table-hover">
      ...
      <tbody class="table-border-bottom-0">
        ...
        <tr>
          ...
          <td>{{$inco->adresse}}</span></td>
          <td>{{$inco->telephone}}</span></td>
          <td>{{$inco->genre}}</span></td>
          <td>{{$inco->motif}}</span></td>
          <td>
            <div class="dropdown">
              <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded"></i></button>
              <div class="dropdown-menu">
                <a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#incoUpdt{{$inco->id}}"><i class="bx bx-edit-alt me-1"></i> Modifier</a>
