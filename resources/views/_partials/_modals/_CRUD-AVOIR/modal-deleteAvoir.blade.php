<!-- Enable OTP Modal -->
<div class="modal fade" id="avoirDst{{$avoir->id}}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-simple modal-enable-otp modal-dialog-centered">
      <div class="modal-content p-3 p-md-5">
        <div class="modal-body">
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          <div class="text-center mb-4">
            <h3 class="mb-3">Suppression d'un avoir</h3>
          </div>
          ...
          <form id="enableOTPForm" class="row g-3" action="{{route('Avoir.destroy', encrypt($avoir->id))}}" method="POST">
            ...
            <div class="col-12">
              <div class="text-wrap">
                Etes-vous sûr de vouloir supprimer definitivement avoir : {{$avoir->libelle}} ?
              </div>
            </div>
            <br>
