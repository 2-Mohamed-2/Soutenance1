  ...
  <div class="offcanvas-body mx-0 flex-grow-0">
    <form id="enableOTPForm" class="row g-3" action="{{route('Resi.store')}}" method="POST">
      ...
      <div class="col-12">
        ...
        <div class="input-group input-group-merge">
          <input required type="text" autocomplete="off" maxlength="10" name="certifions" class="form-control phone-mask" placeholder="certifions " />
        </div>
      </div><br>
      ...
      <div class="col-12">
        ...
        <div class="input-group input-group-merge">
          <input required type="date" autocomplete="off" maxlength="10" name="ne" class="form-control phone-mask" placeholder="Date de Naissance " />
        </div>
      </div>
    ...
    <div class="col-12">
        ...
        <div class="input-group input-group-merge">
          <input required type="text" autocomplete="off" maxlength="10" name="fils" class="form-control phone-mask" placeholder="Nom du pere" />
        </div>
      </div>
      ...
      <div class="col-12">
        ...
        <div class="input-group input-group-merge">
          <input required type="text" autocomplete="off" maxlength="10" name="et" class="form-control phone-mask" placeholder="Nom de la  mere" />
        </div>
      </div>
      ...
      <div class="col-12">
        ...
        <div class="input-group input-group-merge">
          <input required type="text" autocomplete="off" maxlength="10" name="resulte" class="form-control phone-mask" placeholder="resulte" />
        </div>
      </div>
      ...
      <div class="col-12">
        ...
        <div class="input-group input-group-merge">
          <input required type="date" autocomplete="off" maxlength="10" name="kati" class="form-control phone-mask" placeholder="Date de creation" />
        </div>
      </div>
